...
- الكمية قد تُكتب: `×٣` أو `*3` أو `عدد 3` أو `ق٣` (ق=قطعة) أو `3 نسخ` أو بدون كلمة (مجرد رقم مفرد بجانب المقاس).
...
**للإخراج**: أضف حقل `line_items` (مصفوفة) في JSON، كل عنصر: `{ "width_cm": رقم, "height_cm": رقم, "quantity": رقم, "meters": رقم, "unit": "cm"|"m"|"mm", "raw": "النص الأصلي كما قرأته" }`. ثم `calculated_meters_from_dimensions` = مجموع `meters` لكل البنود.
