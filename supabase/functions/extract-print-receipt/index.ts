...
- الرولات المتاحة بالسنتيمتر: [100, 150, 200, 300]. **لا توجد أي رولة أكبر من 300 سم إطلاقاً.**
- لكل بند مع عرض W وارتفاع H وكمية Q:
  1. الخيار الأول (إذا W ≤ 300): أصغر رولة من القائمة ≥ W. المساحة = (rollW × H × Q) ÷ 10000.
  2. الخيار الثاني (إذا H ≤ 300، تدوير القماشة): أصغر رولة من القائمة ≥ H. المساحة = (rollH × W × Q) ÷ 10000.
  3. اختر الخيار ذو **المساحة الأقل**. إذا كان خيار واحد فقط ممكناً، اعتمده.
  4. إذا كلا البُعدين > 300 → غير ممكن، اعتبر البند خطأً وأهمله مع ذكر السبب.

**مهم — حالة بُعد واحد > 300:** كثيراً ما يكون أحد البُعدين كبيراً (مثل 400 سم) والآخر صغيراً (مثل 150 سم). هذا **طبيعي ومسموح**: استخدم البُعد الصغير كعرض الرولة تلقائياً، والكبير كطول الطباعة. **لا تحاول إيجاد رولة أكبر من 300 سم، ولا تقرّب 400 إلى 300، ولا تتحدث عن "هدر" أو "رولتين"**. مثال: 400×150 على فلكس → استخدم رولة 150 سم بطول 400 سم → المساحة = (150 × 400 × 1) ÷ 10000 = 6 م².

**خوارزمية الاستيكر (sticker):**
- الاستيكر يعتمد على **المقاس الفعلي (الصافي)** غالباً وليس مساحة الرولة.
- الرولات المتاحة للاستيكر بالسنتيمتر: [100, 120, 150] (للتحقق من الإمكانية فقط).
- إذا كان أصغر بُعد > 150 سم → غير ممكن، أهمل البند مع ذكر السبب.
- الحساب صافي بدون تقريب رولة: المساحة = (W × H × Q) ÷ 10000.
...
- **للخامات العامة لا تستخدم الحساب الصافي**؛ استخدم خوارزمية الرولات أعلاه (أصغر رولة من [100,150,200,300] ≥ أحد البُعدين، واختر الخيار الأقل مساحة). أما الاستيكر فاستخدم الحساب الصافي (W×H×Q÷10000) مع التحقق فقط من ألا يتجاوز أصغر بعد 150 سم.
